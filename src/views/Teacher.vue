<template>
  <div>
    ...
    <div id="newQuiz" v-if="create"><input id="questionTitle" type="text" v-model="newquiz" placeholder="Input title."/>
      <button class="createQuestion" id="exit" @click="exit()">Exit</button>
      <div id="questionBox">
        <div v-for="(question, num) in questions" v-bind:key="num" class="questionTeacher">
          <span class="blockback">{{num}}.</span><input class="inputTeacher" type="text" v-model="question.title" placeholder="Please input the title of your question.">
          <div v-if= "question.type == 'MUL'" class="options">
            A. <input class="inputTeacher" type="text" v-model="question.options.A" placeholder="Input option A"><br>
            B. <input class="inputTeacher" type="text" v-model="question.options.B" placeholder="Input option B."><br>
            C. <input class="inputTeacher" type="text" v-model="question.options.C" placeholder="Input option C."><br>
            D. <input class="inputTeacher" type="text" v-model="question.options.D" placeholder="Input option D."><br>
          </div>
        </div>
      <div id="buttonBox">
